...
return [
    ...
    */
    ...
    'temporary_file_upload' => [
        ...
        /*
         * Sin tope de tamaño **a propósito**; el default de Livewire es
         * `max:12288` (12 MB). Ver QA-F-03 y AUT-03.
         *
         * Esta validación corre antes que el componente y, al fallar, descarta
         * la petición de subida **entera**: el operador perdía todas las hojas
         * del lote y veía un mensaje del framework en inglés. F03-UT-03 exige
         * lo contrario — que la hoja rechazada muestre su motivo y las demás
         * se conserven.
         *
         * Poner aquí el límite del producto no lo resolvería: solo movería el
         * umbral, y una hoja por encima de ese número volvería a arrastrar el
         * lote entero. Por eso el tope vive donde puede aplicarse hoja por
         * hoja —el servicio de dominio, hoy su doble, con los 15 MB que
         * declara `docs/contratos/digitalizacion.md`— y aquí solo se exige que
         * llegue un archivo.
         *
